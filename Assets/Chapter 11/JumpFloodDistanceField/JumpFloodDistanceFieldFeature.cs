...
{
    private const string ShaderName = "Hidden/Chapter11/JumpFloodDistanceField";

    [Tooltip("Name used for Render Graph passes and profiler markers.")]
    public string ProfilingName = "Jump Flood Distance Field";

    [Tooltip("Material that uses Hidden/Chapter11/JumpFloodDistanceField. Assign the included material so the shader is included in builds.")]
