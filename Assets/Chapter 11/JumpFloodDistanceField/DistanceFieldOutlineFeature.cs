...
public sealed class DistanceFieldOutlineFeature : ScriptableRendererFeature
{
    private const string ShaderName =
        "Hidden/Chapter11/JumpFloodDistanceField/Outline";

    [Tooltip("Name used for the Render Graph pass and profiler marker.")]
    public string ProfilingName = "Distance Field Outline";

    [Tooltip("Material that uses Hidden/Chapter11/JumpFloodDistanceField/Outline. Assign the included material so the shader is retained in player builds.")]
