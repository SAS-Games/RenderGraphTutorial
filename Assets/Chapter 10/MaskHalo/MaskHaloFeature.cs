...
{
    private const string HaloShaderName = "Hidden/Chapter10/MaskHalo/Composite";

    [Tooltip("Name used for Render Graph passes and profiler markers.")]
    public string ProfilingName = "Mask Halo";

    [Tooltip("Material that uses Hidden/Chapter10/MaskHalo/Composite. Assign MaskHaloComposite so the shader is included in builds.")]
